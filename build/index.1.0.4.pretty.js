...
(() => {
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of ml(t))
        !pl.call(e, i) &&
          ...
          Nr(e, i, {
            get: () => t[i],
            enumerable: !(r = dl(t, i)) || r.enumerable,
          });
    return e;
  };
  var Wr = (e, t, n) => (
    ...
    hl(
      t || !e || !e.__esModule
        ? Nr(n, "default", { value: e, enumerable: !0 })
        : n,
      e,
    )
  );
    ...
    (function (e, t) {
      ...
      function r(a, f) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          for (p = 0; p < A.length; p++)
            ((d = A[p]),
              f.indexOf(d) >= 0 ||
                (Object.prototype.propertyIsEnumerable.call(a, d) &&
                  (v[d] = a[d])));
        }
        return v;
      }
        ...
        return (
          ...
          (function (d, p) {
            if (
              ...
              try {
                for (
                  var M, I = d[Symbol.iterator]();
                  !(A = (M = I.next()).done) &&
                  (v.push(M.value), !p || v.length !== p);
                  A = !0
                );
              } catch (F) {
                ((q = !0), (P = F));
      ...
      function o(a) {
        return (
          (function (f) {
            if (Array.isArray(f)) {
              for (var d = 0, p = new Array(f.length); d < f.length; d++)
                p[d] = f[d];
              return p;
            }
          })(a) ||
      ...
      function l() {
        var a = typeof globalThis < "u" ? globalThis : void 0;
        return a && a.scheduler && a.scheduler.yield
          ? a.scheduler.yield().catch(function (f) {
              return (
                console.error("Failed to yield to main: ", f),
      ...
      function s(a) {
        var f,
          d = "algoliasearch-client-js-".concat(a.key),
          p = function () {
            return (
              f === void 0 && (f = a.localStorage || window.localStorage),
              f
            );
          },
          v = function () {
            return JSON.parse(p().getItem(d) || "{}");
          },
          A = function (P) {
            p().setItem(d, JSON.stringify(P));
          },
          q = function () {
            var P = a.timeToLive ? 1e3 * a.timeToLive : null,
              M = v(),
              I = new Date().getTime();
            return Object.fromEntries(
              Object.entries(M).filter(function (F) {
                var R = i(F, 2)[1];
                return (
                  !(!R || R.timestamp === void 0) &&
                  (!P || R.timestamp + P >= I)
                );
              }),
            );
        ...
        return {
          get: function (P, M) {
            ...
            return l().then(function () {
              var F = q(),
                R = F[JSON.stringify(P)];
              return (
                A(F),
                R
                  ? R.value
                  : M().then(function (_) {
                      return I.miss(_).then(function () {
                        return _;
                      });
                    })
              );
          ...
          delete: function (P) {
            return l().then(function () {
              var M = v();
              (delete M[JSON.stringify(P)], p().setItem(d, JSON.stringify(M)));
            });
          },
          clear: function () {
        ...
        return d === void 0
          ...
          : {
              get: function (p, v) {
                ...
                return d.get(p, v, A).catch(function () {
                  return c({ caches: f }).get(p, v, A);
                });
              },
              set: function (p, v) {
                return d.set(p, v).catch(function () {
                  return c({ caches: f }).set(p, v);
                });
              },
              delete: function (p) {
                return d.delete(p).catch(function () {
                  return c({ caches: f }).delete(p);
                });
              },
              clear: function () {
                return d.clear().catch(function () {
                  return c({ caches: f }).clear();
                });
              },
            };
      }
        ...
        return {
          get: function (d, p) {
            var v =
              ...
              A = JSON.stringify(d);
            if (A in f)
              return Promise.resolve(a.serializable ? JSON.parse(f[A]) : f[A]);
            var q = p(),
              P =
                (v && v.miss) ||
                function () {
          ...
          set: function (d, p) {
            return (
              (f[JSON.stringify(d)] = a.serializable ? JSON.stringify(p) : p),
              Promise.resolve(p)
            );
          },
          delete: function (d) {
            return (delete f[JSON.stringify(d)], Promise.resolve());
          },
          clear: function () {
      ...
      function g(a, f, d) {
        var p = { "x-algolia-api-key": d, "x-algolia-application-id": f };
        return {
          headers: function () {
            return a === E.WithinHeaders ? p : {};
          },
          queryParameters: function () {
            return a === E.WithinQueryParameters ? p : {};
          },
        };
      }
      function u(a) {
      ...
      var E = { WithinQueryParameters: 0, WithinHeaders: 1 };
      function T(a, f) {
        var d = a || {},
          p = d.data || {};
        return (
          ...
          {
            data: Object.entries(p).length > 0 ? p : void 0,
            timeout: d.timeout || f,
            headers: d.headers || {},
      ...
      var k = { Read: 1, Write: 2, Any: 3 },
        D = 1,
        K = 2,
        C = 3;
      function ee(a) {
        var f =
          arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : D;
        return n(n({}, a), {}, { status: f, lastUpdate: Date.now() });
      }
      function ye(a) {
        return typeof a == "string"
          ? { protocol: "https", url: a, accept: k.Any }
          : {
              protocol: a.protocol || "https",
              url: a.url,
              accept: a.accept || k.Any,
            };
      }
      var he = "DELETE",
        X = "GET",
      ...
      function Vt(a, f) {
        return Promise.all(
          f.map(function (d) {
            return a.get(d, function () {
              return Promise.resolve(ee(d));
            });
          }),
        ).then(function (d) {
          var p = d.filter(function (q) {
              return (function (P) {
                return P.status === D || Date.now() - P.lastUpdate > 12e4;
              })(q);
            }),
            v = d.filter(function (q) {
              return (function (P) {
                return P.status === C && Date.now() - P.lastUpdate <= 12e4;
              })(q);
            }),
            A = [].concat(o(p), o(v));
          return {
            getTimeout: function (q, P) {
              return (v.length === 0 && q === 0 ? 1 : v.length + 3 + q) * P;
            },
            statelessHosts:
              A.length > 0
                ? A.map(function (q) {
      ...
      function zt(a, f, d, p) {
        var v = [],
          A = (function (_, z) {
            if (!(_.method === X || (_.data === void 0 && z.data === void 0))) {
              var U = Array.isArray(_.data) ? _.data : n(n({}, _.data), z.data);
              return JSON.stringify(U);
            }
          })(d, p),
          q = (function (_, z) {
            var U = n(n({}, _.headers), z.headers),
              Q = {};
            return (
          ...
          P = d.method,
          M = d.method !== X ? {} : n(n({}, d.data), p.data),
          I = n(
            n(
              n({ "x-algolia-agent": a.userAgent.value }, a.queryParameters),
              M,
            ),
            p.queryParameters,
          ),
          ...
          R = function _(z, U) {
            ...
            var ie = {
                ...
                method: P,
                url: Qt(Q, d.path, I),
                connectTimeout: U(F, a.timeouts.connect),
                responseTimeout: U(F, p.timeout),
              },
              ve = function (Ae) {
                var Te = {
                  request: ie,
              ...
              qt = {
                onSuccess: function (Ae) {
                  return (function (Te) {
                    try {
                      return JSON.parse(Te.content);
                    } catch (lt) {
                      throw (function (ze, ht) {
                        return {
                ...
                onRetry: function (Ae) {
                  ...
                  return (
                    Ae.isTimedOut && F++,
                    Promise.all([
                      a.logger.info("Retryable failure", It(Te)),
                      a.hostsCache.set(Q, ee(Q, Ae.isTimedOut ? C : K)),
                    ]).then(function () {
                      return _(z, U);
                    })
                  );
                  ...
                  throw (
                    ...
                    (function (Te, lt) {
                      var ze = Te.content,
                        ...
                        Pt = ze;
                      try {
                        Pt = JSON.parse(ze).message;
                      } catch {}
                      return (function (Yt, Rn, ul) {
                        return {
                          name: "ApiError",
                          message: Yt,
                          status: Rn,
                          transporterStackTrace: ul,
                        };
                      })(Pt, ht, lt);
                    })(Ae, Ht(v))
                  );
            ...
            return a.requester.send(ie).then(function (Ae) {
              return (function (Te, lt) {
                return (function (ze) {
                  var ht = ze.status;
                  return (
                    ze.isTimedOut ||
                    (function (Pt) {
                      var Yt = Pt.isTimedOut,
                        Rn = Pt.status;
                      return !Yt && ~~Rn == 0;
                    })(ze) ||
                    (~~(ht / 100) != 2 && ~~(ht / 100) != 4)
        ...
        return Vt(a.hostsCache, f).then(function (_) {
          return R(o(_.statelessHosts).reverse(), _.getTimeout);
        });
      }
      function De(a) {
        var f = a.hostsCache,
          ...
          F = {
            ...
            headers: a.headers,
            queryParameters: I,
            hosts: M.map(function (R) {
              return ye(R);
            }),
            read: function (R, _) {
              var z = T(_, F.timeouts.read),
                U = function () {
                  return zt(
                    F,
                    F.hosts.filter(function (ie) {
                      return (ie.accept & k.Read) != 0;
                    }),
                    R,
                    z,
                  );
                };
              if ((z.cacheable !== void 0 ? z.cacheable : R.cacheable) !== !0)
                return U();
              var Q = {
                request: R,
                mappedRequestOptions: z,
                transporter: {
              ...
              return F.responsesCache.get(
                Q,
                function () {
                  return F.requestsCache.get(Q, function () {
                    return F.requestsCache
                      .set(Q, U())
                      .then(
                        function (ie) {
                          return Promise.all([F.requestsCache.delete(Q), ie]);
                        },
                        function (ie) {
                          return Promise.all([
                            F.requestsCache.delete(Q),
                            Promise.reject(ie),
                          ]);
                        },
                      )
                ...
                {
                  miss: function (ie) {
                    return F.responsesCache.set(Q, ie);
                  },
                },
              );
            },
            write: function (R, _) {
              return zt(
                F,
                F.hosts.filter(function (z) {
                  return (z.accept & k.Write) != 0;
                }),
                R,
                T(_, F.timeouts.write),
              );
            },
          };
        return F;
      ...
      function Kt(a) {
        var f = {
          ...
          add: function (d) {
            var p = "; "
              .concat(d.segment)
              .concat(d.version !== void 0 ? " (".concat(d.version, ")") : "");
            return (
              f.value.indexOf(p) === -1 &&
                (f.value = "".concat(f.value).concat(p)),
              f
            );
          },
        };
      ...
      function Qt(a, f, d) {
        var p = Mt(d),
          v = ""
            .concat(a.protocol, "://")
            .concat(a.url, "/")
            .concat(f.charAt(0) === "/" ? f.substr(1) : f);
        return (p.length && (v += "?".concat(p)), v);
      }
      function Mt(a) {
      ...
      function It(a) {
        var f = a.request.headers["x-algolia-api-key"]
          ? { "x-algolia-api-key": "*****" }
          : {};
        return n(
          n({}, a),
          {},
          {
            request: n(
              n({}, a.request),
              {},
              { headers: n(n({}, a.request.headers), f) },
            ),
          },
        );
      }
      var Jt = function (a) {
          return function (f, d) {
            return a.transporter.write(
              { method: V, path: "2/abtests", data: f },
              d,
            );
          };
        },
        ke = function (a) {
          return function (f, d) {
            return a.transporter.write(
              { method: he, path: w("2/abtests/%s", f) },
              d,
            );
          };
        },
        ...
        L = function (a) {
          return function (f) {
            return a.transporter.read({ method: X, path: "2/abtests" }, f);
          };
        },
        x = function (a) {
          return function (f, d) {
            return a.transporter.write(
              { method: V, path: w("2/abtests/%s/stop", f) },
              d,
            );
          };
        },
        ...
        O = function (a) {
          return function (f, d) {
            return a.transporter.write(
              { method: V, path: "1/strategies/personalization", data: f },
              d,
            );
          };
        };
      function W(a) {
        return (function f(d) {
          return a.request(d).then(function (p) {
            if ((a.batch !== void 0 && a.batch(p.hits), !a.shouldStop(p)))
              return p.cursor
                ? f({ cursor: p.cursor })
                : f({ page: (d.page || 0) + 1 });
          });
      ...
      var G = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.queryParameters,
              A = r(p, ["queryParameters"]),
              q = n({ acl: f }, v !== void 0 ? { queryParameters: v } : {});
            return h(
              a.transporter.write({ method: V, path: "1/keys", data: q }, A),
              function (P, M) {
                return u(function (I) {
                  return be(a)(P.key, M).catch(function (F) {
        ...
        j = function (a) {
          return function (f, d, p) {
            var v = T(p);
            return (
              (v.queryParameters["X-Algolia-User-ID"] = f),
              a.transporter.write(
                { method: V, path: "1/clusters/mapping", data: { cluster: d } },
                v,
              )
            );
          };
          ...
          return function (f, d) {
            return h(
              a.transporter.write(
                {
                  method: V,
                  path: w("/1/dictionaries/%s/batch", f),
                  data: {
          ...
          return function (f, d, p) {
            return h(
              a.transporter.write(
                {
                  method: V,
                  path: w("1/indexes/%s/operation", f),
                  data: { operation: "copy", destination: d },
                },
                p,
              ),
              function (v, A) {
                return Pe(a)(f, { methods: { waitTask: ge } }).waitTask(
                  v.taskID,
                  A,
                );
              },
        ...
        fe = function (a) {
          return function (f, d, p) {
            return le(a)(f, d, n(n({}, p), {}, { scope: [Dn.Rules] }));
          };
        },
        ce = function (a) {
          return function (f, d, p) {
            return le(a)(f, d, n(n({}, p), {}, { scope: [Dn.Settings] }));
          };
        },
        Me = function (a) {
          return function (f, d, p) {
            return le(a)(f, d, n(n({}, p), {}, { scope: [Dn.Synonyms] }));
          };
        },
        ne = function (a) {
          return function (f, d) {
            return f.method === X
              ? a.transporter.read(f, d)
              : a.transporter.write(f, d);
          };
        },
        we = function (a) {
          return function (f, d) {
            return h(
              a.transporter.write({ method: he, path: w("1/keys/%s", f) }, d),
              function (p, v) {
                return u(function (A) {
                  return be(a)(f, v)
                    .then(A)
        ...
        qe = function (a) {
          return function (f, d, p) {
            var v = d.map(function (A) {
              return { action: "deleteEntry", body: { objectID: A } };
            });
            return h(
              a.transporter.write(
                {
                  method: V,
                  path: w("/1/dictionaries/%s/batch", f),
                  data: { clearExistingDictionaryEntries: !1, requests: v },
                },
                p,
              ),
              function (A, q) {
                return pt(a)(A.taskID, q);
              },
            );
          };
        },
        ...
        at = function (a) {
          return function (f, d) {
            return a.transporter.read(
              { method: X, path: w("1/task/%s", f.toString()) },
              d,
            );
          };
        },
        ...
        Z = function (a) {
          return function (f) {
            return a.transporter.read({ method: X, path: "1/logs" }, f);
          };
        },
        He = function (a) {
          return function (f) {
        ...
        Re = function (a) {
          return function (f, d) {
            return a.transporter.read(
              { method: X, path: w("1/clusters/mapping/%s", f) },
              d,
            );
          };
        },
        Ve = function (a) {
          return function (f) {
            var d = f || {},
              p = d.retrieveMappings,
              v = r(d, ["retrieveMappings"]);
            return (
              p === !0 && (v.getClusters = !0),
              a.transporter.read(
          ...
          return function (f) {
            var d =
                arguments.length > 1 && arguments[1] !== void 0
                  ? arguments[1]
                  : {},
              p = { transporter: a.transporter, appId: a.appId, indexName: f };
            return b(p, d.methods);
          };
        },
        gt = function (a) {
          return function (f) {
            return a.transporter.read({ method: X, path: "1/keys" }, f);
          };
        },
        kt = function (a) {
          return function (f) {
            return a.transporter.read({ method: X, path: "1/clusters" }, f);
          };
        },
        qn = function (a) {
          return function (f) {
            return a.transporter.read({ method: X, path: "1/indexes" }, f);
          };
        },
        pa = function (a) {
          return function (f) {
              ...
              a.transporter.write(
                {
                  method: V,
                  path: w("1/indexes/%s/operation", f),
                  data: { operation: "move", destination: d },
                },
                p,
              ),
              function (v, A) {
        ...
        wa = function (a) {
          return function (f, d) {
            return h(
              a.transporter.write(
                { method: V, path: "1/indexes/*/batch", data: { requests: f } },
                d,
              ),
              function (p, v) {
                return Promise.all(
                  Object.keys(p.taskID).map(function (A) {
                    return Pe(a)(A, { methods: { waitTask: ge } }).waitTask(
                      p.taskID[A],
                      v,
                    );
                  }),
        ...
        ya = function (a) {
          return function (f, d) {
            return a.transporter.read(
              { method: V, path: "1/indexes/*/objects", data: { requests: f } },
              d,
            );
          };
        },
        Mr = function (a) {
          return function (f, d) {
            var p = f.map(function (v) {
              return n(n({}, v), {}, { params: Mt(v.params || {}) });
            });
            return a.transporter.read(
              {
                method: V,
            ...
            return Promise.all(
              f.map(function (p) {
                var v = p.params,
                  A = v.facetName,
                  q = v.facetQuery,
                  P = r(v, ["facetName", "facetQuery"]);
                return Pe(a)(p.indexName, {
                  methods: { searchForFacetValues: Or },
                }).searchForFacetValues(A, q, n(n({}, d), P));
              }),
            );
          };
        },
        ba = function (a) {
          return function (f, d) {
            var p = T(d);
            return (
              (p.queryParameters["X-Algolia-User-ID"] = f),
              a.transporter.write({ method: he, path: "1/clusters/mapping" }, p)
            );
          };
        },
        va = function (a) {
              ...
              a.transporter.write(
                {
                  method: V,
                  path: w("/1/dictionaries/%s/batch", f),
                  data: { clearExistingDictionaryEntries: !0, requests: v },
                },
                p,
              ),
              function (A, q) {
        ...
        Ea = function (a) {
          return function (f, d) {
            return h(
              a.transporter.write(
                { method: V, path: w("1/keys/%s/restore", f) },
                d,
              ),
              function (p, v) {
                return u(function (A) {
                  return be(a)(f, v).catch(function (q) {
                    if (q.status !== 404) throw q;
                    return A();
                  });
                });
        ...
        Sa = function (a) {
          return function (f, d, p) {
            return a.transporter.read(
              {
                method: V,
                path: w("/1/dictionaries/%s/search", f),
                data: { query: d },
                cacheable: !0,
              },
              p,
        ...
        La = function (a) {
          return function (f, d) {
            return h(
              a.transporter.write(
                { method: mt, path: "/1/dictionaries/*/settings", data: f },
                d,
              ),
              function (p, v) {
                return pt(a)(p.taskID, v);
        ...
        xa = function (a) {
          return function (f, d) {
            var p = Object.assign({}, d),
              v = d || {},
              A = v.queryParameters,
              q = r(v, ["queryParameters"]),
              P = A ? { queryParameters: A } : {},
              M = [
                "acl",
                "indexes",
                "referers",
            ...
            return h(
              a.transporter.write(
                { method: mt, path: w("1/keys/%s", f), data: P },
                q,
              ),
              function (I, F) {
                return u(function (R) {
                  return be(a)(f, F).then(function (_) {
                    return (function (z) {
                      return Object.keys(p)
                        ...
                        .every(function (U) {
                          if (Array.isArray(z[U]) && Array.isArray(p[U])) {
                            var Q = z[U];
                            return (
                              Q.length === p[U].length &&
                              Q.every(function (ie, ve) {
                                return ie === p[U][ve];
                              })
                            );
                          }
        ...
        pt = function (a) {
          return function (f, d) {
            return u(function (p) {
              return at(a)(f, d).then(function (v) {
                return v.status !== "published" ? p() : void 0;
              });
            });
          };
        },
          ...
          return function (f, d) {
            return h(
              a.transporter.write(
                {
                  method: V,
                  path: w("1/indexes/%s/batch", a.indexName),
                  data: { requests: f },
                },
                d,
              ),
              function (p, v) {
                return ge(a)(p.taskID, v);
              },
            );
          };
        },
          ...
          return function (f) {
            return W(
              n(
                n(
                  {
                    shouldStop: function (d) {
                      return d.cursor === void 0;
                    },
                  },
                  f,
                ),
                {},
                {
                  request: function (d) {
                    return a.transporter.read(
                      {
                        method: V,
                        path: w("1/indexes/%s/browse", a.indexName),
                        data: d,
                      },
                      f,
                    );
        ...
        Ha = function (a) {
          return function (f) {
            var d = n({ hitsPerPage: 1e3 }, f);
            return W(
              n(
                n(
                  {
                    shouldStop: function (p) {
                      return p.hits.length < d.hitsPerPage;
                    },
                  },
                  d,
                ),
                ...
                {
                  request: function (p) {
                    return Dr(a)("", n(n({}, d), p)).then(function (v) {
                      return n(
                        n({}, v),
                        {},
                        {
                          hits: v.hits.map(function (A) {
                            return (delete A._highlightResult, A);
                          }),
                        },
                      );
                    });
          ...
          return function (f) {
            ...
            return W(
              n(
                ...
                {
                  request: function (p) {
                    return Rr(a)("", n(n({}, d), p)).then(function (v) {
                      return n(
                        n({}, v),
                        {},
                        {
          ...
          return function (f, d, p) {
            ...
            return h(
              (function M() {
                ...
                for (
                  I = F;
                  I < f.length && (R.push(f[I]), R.length !== (A || 1e3));
                  I++
                );
                return R.length === 0
                  ? Promise.resolve(P)
                  : Ir(a)(
                      R.map(function (_) {
                        return { action: d, body: _ };
                      }),
                      q,
                    ).then(function (_) {
                      return (
                        (P.objectIDs = P.objectIDs.concat(_.objectIDs)),
                        P.taskIDs.push(_.taskID),
                        I++,
                        M(I)
                      );
                    });
        ...
        ka = function (a) {
          return function (f) {
            return h(
              a.transporter.write(
                { method: V, path: w("1/indexes/%s/clear", a.indexName) },
                f,
              ),
              function (d, p) {
                return ge(a)(d.taskID, p);
              },
            );
          };
        },
        qa = function (a) {
          return function (f) {
            var d = f || {},
              p = d.forwardToReplicas,
              v = T(r(d, ["forwardToReplicas"]));
            return (
              p && (v.queryParameters.forwardToReplicas = 1),
              h(
                a.transporter.write(
                  {
                    method: V,
                    path: w("1/indexes/%s/rules/clear", a.indexName),
                  },
                  v,
                ),
                function (A, q) {
                  return ge(a)(A.taskID, q);
                },
              )
            );
          };
            ...
            return (
              ...
              h(
                a.transporter.write(
                  {
                    method: V,
                    path: w("1/indexes/%s/synonyms/clear", a.indexName),
                  },
                  v,
                ),
                function (A, q) {
          ...
          return function (f, d) {
            return h(
              a.transporter.write(
                {
                  method: V,
                  path: w("1/indexes/%s/deleteByQuery", a.indexName),
                  data: f,
                },
                d,
              ),
        ...
        kr = function (a) {
          return function (f) {
            return h(
              a.transporter.write(
                { method: he, path: w("1/indexes/%s", a.indexName) },
                f,
              ),
              function (d, p) {
                return ge(a)(d.taskID, p);
        ...
        Fa = function (a) {
          return function (f, d) {
            return h(
              qr(a)([f], d).then(function (p) {
                return { taskID: p.taskIDs[0] };
              }),
              function (p, v) {
                return ge(a)(p.taskID, v);
              },
        ...
        qr = function (a) {
          return function (f, d) {
            ...
            return Pn(a)(p, je.DeleteObject, d);
          };
        },
        Oa = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.forwardToReplicas,
              A = T(r(p, ["forwardToReplicas"]));
            return (
              v && (A.queryParameters.forwardToReplicas = 1),
              h(
                a.transporter.write(
                  {
                    method: he,
                    path: w("1/indexes/%s/rules/%s", a.indexName, f),
                  },
                  A,
                ),
                function (q, P) {
                  return ge(a)(q.taskID, P);
                },
              )
            );
          };
            ...
            return (
              ...
              h(
                a.transporter.write(
                  {
                    method: he,
                    path: w("1/indexes/%s/synonyms/%s", a.indexName, f),
                  },
                  A,
                ),
                function (q, P) {
        ...
        ja = function (a) {
          return function (f, d, p) {
            return a.transporter.read(
              {
                method: V,
                path: w("1/answers/%s/prediction", a.indexName),
                data: { query: f, queryLanguages: d },
                cacheable: !0,
              },
              p,
            );
        ...
        Na = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.query,
              A = p.paginate,
              q = r(p, ["query", "paginate"]),
              P = 0;
            return (function M() {
              return Fr(a)(v || "", n(n({}, q), {}, { page: P })).then(
                function (I) {
                  for (
                    var F = 0, R = Object.entries(I.hits);
                    F < R.length;
                    F++
                  ) {
                    var _ = i(R[F], 2),
                      ...
                      U = _[1];
                    if (f(U))
                      return { object: U, position: parseInt(z, 10), page: P };
                  }
                  if ((P++, A === !1 || P >= I.nbPages))
                    throw {
        ...
        _a = function (a) {
          return function (f, d) {
            return a.transporter.read(
              { method: X, path: w("1/indexes/%s/%s", a.indexName, f) },
              d,
            );
          };
        },
        Wa = function () {
          return function (a, f) {
            for (var d = 0, p = Object.entries(a.hits); d < p.length; d++) {
              var v = i(p[d], 2),
                A = v[0];
              if (v[1].objectID === f) return parseInt(A, 10);
            }
            return -1;
          };
        },
        $a = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.attributesToRetrieve,
              A = r(p, ["attributesToRetrieve"]),
              q = f.map(function (P) {
                return n(
                  { indexName: a.indexName, objectID: P },
                  v ? { attributesToRetrieve: v } : {},
                );
              });
            return a.transporter.read(
              { method: V, path: "1/indexes/*/objects", data: { requests: q } },
              A,
            );
          };
        },
        Ua = function (a) {
          return function (f, d) {
            return a.transporter.read(
              { method: X, path: w("1/indexes/%s/rules/%s", a.indexName, f) },
              d,
            );
          };
        },
        Pr = function (a) {
          return function (f) {
            return a.transporter.read(
              {
                method: X,
                path: w("1/indexes/%s/settings", a.indexName),
                data: { getVersion: 2 },
              },
              f,
            );
        ...
        Ga = function (a) {
          return function (f, d) {
            return h(
              Cr(a)([f], d).then(function (p) {
                return { objectID: p.objectIDs[0], taskID: p.taskIDs[0] };
              }),
              function (p, v) {
                return ge(a)(p.taskID, v);
              },
        ...
        Cr = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.createIfNotExists,
              A = r(p, ["createIfNotExists"]),
              q = v ? je.PartialUpdateObject : je.PartialUpdateObjectNoCreate;
            return Pn(a)(f, q, A);
          };
        },
        Va = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.safe,
              A = p.autoGenerateObjectIDIfNotExist,
              q = p.batchSize,
              P = r(p, ["safe", "autoGenerateObjectIDIfNotExist", "batchSize"]),
              M = function (U, Q, ie, ve) {
                return h(
                  a.transporter.write(
                    {
                      method: V,
                      path: w("1/indexes/%s/operation", U),
                      data: { operation: ie, destination: Q },
                    },
                    ve,
                  ),
                  function (qt, Ae) {
                    return ge(a)(qt.taskID, Ae);
                  },
                );
              },
              I = Math.random().toString(36).substring(7),
              F = "".concat(a.indexName, "_tmp_").concat(I),
              R = Cn({
                appId: a.appId,
              ...
              z = M(
                ...
                F,
                "copy",
                n(n({}, P), {}, { scope: ["settings", "synonyms", "rules"] }),
              );
            return (
              _.push(z),
              h(
                (v ? z.wait(P) : z)
                  .then(function () {
                    var U = R(
                      ...
                      n(
                        n({}, P),
                        {},
                        { autoGenerateObjectIDIfNotExist: A, batchSize: q },
                      ),
                    );
                    return (_.push(U), v ? U.wait(P) : U);
                  })
                  .then(function () {
                    var U = M(F, a.indexName, "move", P);
                    return (_.push(U), v ? U.wait(P) : U);
                  })
                  .then(function () {
                  ...
                  .then(function (U) {
                    var Q = i(U, 3),
                      ...
                      qt = Q[2];
                    return {
                      objectIDs: ve.objectIDs,
                      taskIDs: [ie.taskID].concat(o(ve.taskIDs), [qt.taskID]),
                    };
                  })
                  .catch(function (U) {
                    return kr({
        ...
        za = function (a) {
          return function (f, d) {
            return Fn(a)(f, n(n({}, d), {}, { clearExistingRules: !0 }));
          };
        },
        Ka = function (a) {
          return function (f, d) {
            return On(a)(f, n(n({}, d), {}, { clearExistingSynonyms: !0 }));
          };
        },
        Qa = function (a) {
          return function (f, d) {
            return h(
              Cn(a)([f], d).then(function (p) {
                return { objectID: p.objectIDs[0], taskID: p.taskIDs[0] };
              }),
              function (p, v) {
                return ge(a)(p.taskID, v);
        ...
        Cn = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.autoGenerateObjectIDIfNotExist,
              A = r(p, ["autoGenerateObjectIDIfNotExist"]),
              q = v ? je.AddObject : je.UpdateObject;
            if (q === je.UpdateObject) {
              var P = !0,
                M = !1,
                I = void 0;
              try {
                for (
                  var F, R = f[Symbol.iterator]();
                  !(P = (F = R.next()).done);
                  P = !0
                )
        ...
        Fn = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.forwardToReplicas,
              A = p.clearExistingRules,
              q = T(r(p, ["forwardToReplicas", "clearExistingRules"]));
            return (
              v && (q.queryParameters.forwardToReplicas = 1),
              A && (q.queryParameters.clearExistingRules = 1),
              h(
                a.transporter.write(
                  {
                    method: V,
                    path: w("1/indexes/%s/rules/batch", a.indexName),
                    data: f,
                  },
                  q,
                ),
                function (P, M) {
                  return ge(a)(P.taskID, M);
                },
              )
            );
          };
        ...
        On = function (a) {
          return function (f, d) {
            var p = d || {},
              v = p.forwardToReplicas,
              A = p.clearExistingSynonyms,
              q = p.replaceExistingSynonyms,
              P = T(
                r(p, [
                  "forwardToReplicas",
            ...
            return (
              v && (P.queryParameters.forwardToReplicas = 1),
              (q || A) && (P.queryParameters.replaceExistingSynonyms = 1),
              h(
                a.transporter.write(
                  {
                    method: V,
                    path: w("1/indexes/%s/synonyms/batch", a.indexName),
                    data: f,
                  },
                  P,
                ),
                function (M, I) {
                  return ge(a)(M.taskID, I);
                },
              )
            );
          };
        ...
        Fr = function (a) {
          return function (f, d) {
            return a.transporter.read(
              {
                method: V,
                path: w("1/indexes/%s/query", a.indexName),
                data: { query: f },
                cacheable: !0,
              },
              d,
        ...
        Or = function (a) {
          return function (f, d, p) {
            return a.transporter.read(
              {
                method: V,
                path: w("1/indexes/%s/facets/%s/query", a.indexName, f),
                data: { facetQuery: d },
                cacheable: !0,
              },
              p,
        ...
        Dr = function (a) {
          return function (f, d) {
            return a.transporter.read(
              {
                method: V,
                path: w("1/indexes/%s/rules/search", a.indexName),
                data: { query: f },
              },
              d,
            );
        ...
        Rr = function (a) {
          return function (f, d) {
            return a.transporter.read(
              {
                method: V,
                path: w("1/indexes/%s/synonyms/search", a.indexName),
                data: { query: f },
              },
              d,
            );
        ...
        Dn = { Settings: "settings", Synonyms: "synonyms", Rules: "rules" },
        Za = 1,
        el = 2,
        tl = 3,
        Xt = function (a) {
          return function (f, d) {
            var p = f.map(function (v) {
              return n(n({}, v), {}, { threshold: v.threshold || 0 });
            });
            return a.transporter.read(
              {
                method: V,
        ...
        rl = function (a) {
          return function (f, d) {
            return Xt(a)(
              f.map(function (p) {
                return n(n({}, p), {}, { model: "related-products" });
              }),
              d,
            );
          };
          ...
          return function (f, d) {
            var p = f.map(function (v) {
              return n(
                n({}, v),
                {},
                { model: "trending-facets", threshold: v.threshold || 0 },
              );
            });
            return a.transporter.read(
              {
          ...
          return function (f, d) {
            var p = f.map(function (v) {
              return n(
                n({}, v),
                {},
                { model: "trending-items", threshold: v.threshold || 0 },
              );
            });
            return a.transporter.read(
              {
        ...
        al = function (a) {
          return function (f, d) {
            return Xt(a)(
              f.map(function (p) {
                return n(n({}, p), {}, { model: "looking-similar" });
              }),
              d,
            );
          };
          ...
          return function (f, d) {
            var p = f.map(function (v) {
              return n(
                n({}, v),
                {},
                { model: "recommended-for-you", threshold: v.threshold || 0 },
              );
            });
            return a.transporter.read(
              {
      ...
      function sl(a, f) {
        return function (d, p) {
          ...
          var v = p || {},
            A = v.autoGenerateObjectIDIfNotExist,
            q = v.watch,
            P = r(v, ["autoGenerateObjectIDIfNotExist", "watch"]),
            M = A ? je.AddObject : je.UpdateObject;
          return f.push(
            {
              indexName: a,
              pushTaskPayload: { action: M, records: d },
              watch: q,
            },
            P,
          );
      ...
      function cl(a, f) {
        return function (d, p) {
          ...
          var v = p || {},
            A = v.createIfNotExists,
            q = v.watch,
            P = r(v, ["createIfNotExists", "watch"]),
            M = A ? je.PartialUpdateObject : je.PartialUpdateObjectNoCreate;
          return f.push(
            {
              indexName: a,
              pushTaskPayload: { action: M, records: d },
      ...
      function _e(a) {
        return { name: "TransformationConfigurationError", message: a };
      }
      function jr(a, f, d) {
        var p,
          v,
          A = {
              ...
              send: function (M) {
                return new Promise(function (I) {
                  ...
                  (F.open(M.method, M.url, !0),
                    Object.keys(M.headers).forEach(function (U) {
                      return F.setRequestHeader(U, M.headers[U]);
                    }));
                  var R,
                    _ = function (U, Q) {
                      return setTimeout(function () {
                        (F.abort(),
                          I({ status: 0, content: Q, isTimedOut: !0 }));
                      }, 1e3 * U);
                    },
                    z = _(M.connectTimeout, "Connection timeout");
                  ((F.onreadystatechange = function () {
                    F.readyState > F.OPENED &&
                      R === void 0 &&
                      (clearTimeout(z),
                      (R = _(M.responseTimeout, "Socket timeout")));
                  }),
                    (F.onerror = function () {
                      F.status === 0 &&
                        (clearTimeout(z),
                        clearTimeout(R),
                        I({
                          content: F.responseText || "Network request failed",
                          status: F.status,
                          isTimedOut: !1,
                        }));
                    }),
            ...
            logger:
              ...
              {
                debug: function (M, I) {
                  return (Za >= p && console.debug(M, I), Promise.resolve());
                },
                info: function (M, I) {
                  return (el >= p && console.info(M, I), Promise.resolve());
                },
                error: function (M, I) {
                  return (console.error(M, I), Promise.resolve());
                },
              }),
            responsesCache: m(),
            requestsCache: m({ serializable: !1 }),
            hostsCache: c({
              caches: [s({ key: "".concat("4.26.0", "-").concat(a) }), m()],
            }),
            userAgent: Kt("4.26.0").add({ segment: "Browser" }),
          },
          q = n(n({}, A), d),
          P = function () {
            return function (M) {
              return (function (I) {
                var F = I.region || "us",
                  R = g(E.WithinHeaders, I.appId, I.apiKey),
                  _ = De(
                    n(
                      n(
                        {
                          hosts: [
                            {
                              url: "personalization.".concat(F, ".algolia.com"),
                            },
                          ],
                        },
                        I,
                ...
                return b({ appId: I.appId, transporter: _ }, I.methods);
              })(
                n(
                  n(n({}, A), M),
                  {},
        ...
        if (d && d.transformation) {
          if (!d.transformation.region)
            throw _e(
              "`region` must be provided when leveraging the transformation pipeline",
            );
          v = (function (M) {
            if (!M || !M.transformation || !M.transformation.region)
              throw _e(
                "`region` must be provided when leveraging the transformation pipeline",
              );
            if (
              M.transformation.region !== "eu" &&
              M.transformation.region !== "us"
            )
              throw _e(
                "`region` is required and must be one of the following: eu, us",
              );
            var I = M.appId,
              F = g(E.WithinHeaders, I, M.apiKey),
              R = De(
                n(
                  n(
                    {
                  ...
                  {
                    headers: n(
                      n(n({}, F.headers()), { "content-type": "text/plain" }),
                      M.headers,
                    ),
                    queryParameters: n(
                      n({}, F.queryParameters()),
            ...
            return {
              transporter: R,
              appId: I,
              addAlgoliaAgent: function (_, z) {
                (R.userAgent.add({ segment: _, version: z }),
                  R.userAgent.add({ segment: "Ingestion", version: z }),
                  R.userAgent.add({ segment: "Ingestion via Algoliasearch" }));
              },
              clearCache: function () {
                return Promise.all([
              ...
              push: function (_, z) {
                ...
                var ve = z || { queryParameters: {} };
                return R.write(
                  { method: V, path: w("1/push/%s", U), data: Q },
                  n(
                    n({}, ve),
                    {},
                    {
                      queryParameters: n(
                        n({}, ve.queryParameters),
                        {},
                        { watch: ie !== void 0 },
                      ),
                    },
        ...
        return (function (M) {
          var I = M.appId,
            F = g(
              M.authMode !== void 0 ? M.authMode : E.WithinHeaders,
              I,
              M.apiKey,
            ),
            R = De(
              n(
                n(
                  {
                    hosts: [
                      { url: "".concat(I, "-dsn.algolia.net"), accept: k.Read },
                      { url: "".concat(I, ".algolia.net"), accept: k.Write },
                    ].concat(
                      y([
          ...
          n(
            ...
            {},
            {
              methods: {
                search: Mr,
                searchForFacetValues: Hr,
                multipleBatch: wa,
                multipleGetObjects: ya,
                multipleQueries: Mr,
                copyIndex: le,
                copySettings: ce,
                copySynonyms: Me,
                ...
                getLogs: Z,
                listClusters: kt,
                multipleSearchForFacetValues: Hr,
                getApiKey: be,
                addApiKey: G,
                listApiKeys: gt,
                updateApiKey: xa,
                ...
                getTopUserIDs: He,
                removeUserID: ba,
                hasPendingMappings: Ve,
                clearDictionaryEntries: se,
                deleteDictionaryEntries: qe,
                getDictionarySettings: me,
                getAppTask: at,
                replaceDictionaryEntries: va,
                saveDictionaryEntries: Ta,
                searchDictionaryEntries: Sa,
                setDictionarySettings: La,
                waitAppTask: pt,
                customRequest: ne,
                initIndex: function (M) {
                  return function (I) {
                    return n(
                      n(
                        {},
                        Pe(M)(I, {
                          methods: {
                            ...
                            setSettings: Ya,
                            getSettings: Pr,
                            partialUpdateObject: Ga,
                            partialUpdateObjects: Cr,
                            deleteObject: Fa,
                            deleteObjects: qr,
                            deleteBy: Ca,
                            clearObjects: ka,
                            browseObjects: Ma,
                            getObjectPosition: Wa,
                            findObject: Na,
                            exists: Ra,
                            saveSynonym: Xa,
                            saveSynonyms: On,
                            ...
                            deleteSynonym: Da,
                            clearSynonyms: Pa,
                            replaceAllObjects: Va,
                            replaceAllSynonyms: Ka,
                            searchRules: Dr,
                            getRule: Ua,
                            deleteRule: Oa,
                            saveRule: Ja,
                      ...
                      {},
                      {
                        saveObjectsWithTransformation: sl(I, v),
                        partialUpdateObjectsWithTransformation: cl(I, v),
                      },
                    );
                  };
                },
                            ...
                            n(
                              {
                                hosts: [
                                  {
                                    url: "analytics.".concat(F, ".algolia.com"),
                                  },
                                ],
                              },
                              I,
                ...
                getRecommendations: Xt,
                getFrequentlyBoughtTogether: nl,
                getLookingSimilar: al,
                getRecommendedForYou: ll,
                getRelatedProducts: rl,
                getTrendingFacets: il,
                getTrendingItems: ol,
              },
            },
          ),
      ...
      return ((jr.version = "4.26.0"), jr);
    });
  });
  var ta = _r((Lr, xr) => {
    (function (e, t) {
      typeof Lr == "object" && typeof xr < "u"
        ? (xr.exports = t())
        : typeof define == "function" && define.amd
          ? define(t)
          : ((e = e || self)["@algolia/recommend"] = t());
    })(Lr, function () {
      "use strict";
      function e(S, L, x) {
        return (
      ...
      function n(S) {
        for (var L = 1; L < arguments.length; L++) {
          ...
          L % 2
            ? t(Object(x), !0).forEach(function (H) {
                e(S, H, x[H]);
              })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(S, Object.getOwnPropertyDescriptors(x))
              : t(Object(x)).forEach(function (H) {
                  Object.defineProperty(
                    S,
                    H,
                    Object.getOwnPropertyDescriptor(x, H),
                  );
                });
        }
        return S;
        ...
        return (
          ...
          (function (x, H) {
            if (
              ...
              try {
                for (
                  var te, se = x[Symbol.iterator]();
                  !(W = (te = se.next()).done) &&
                  (O.push(te.value), !H || O.length !== H);
                  W = !0
                );
              } catch (le) {
                ((G = !0), (j = le));
      ...
      function i(S) {
        return (
          (function (L) {
            if (Array.isArray(L)) {
              for (var x = 0, H = new Array(L.length); x < L.length; x++)
                H[x] = L[x];
              return H;
            }
          })(S) ||
      ...
      function o() {
        var S = typeof globalThis < "u" ? globalThis : void 0;
        return S && S.scheduler && S.scheduler.yield
          ? S.scheduler.yield().catch(function (L) {
              return (
                console.error("Failed to yield to main: ", L),
      ...
      function l(S) {
        var L,
          x = "algoliasearch-client-js-".concat(S.key),
          H = function () {
            return (
              L === void 0 && (L = S.localStorage || window.localStorage),
              L
            );
          },
          O = function () {
            return JSON.parse(H().getItem(x) || "{}");
          },
          W = function (j) {
            H().setItem(x, JSON.stringify(j));
          },
          G = function () {
            var j = S.timeToLive ? 1e3 * S.timeToLive : null,
              te = O(),
              se = new Date().getTime();
            return Object.fromEntries(
              Object.entries(te).filter(function (le) {
                var fe = r(le, 2)[1];
                return (
                  !(!fe || fe.timestamp === void 0) &&
                  (!j || fe.timestamp + j >= se)
                );
              }),
            );
        ...
        return {
          get: function (j, te) {
            ...
            return o().then(function () {
              var le = G(),
                fe = le[JSON.stringify(j)];
              return (
                W(le),
                fe
                  ? fe.value
                  : te().then(function (ce) {
                      return se.miss(ce).then(function () {
                        return ce;
                      });
                    })
              );
          ...
          delete: function (j) {
            return o().then(function () {
              var te = O();
              (delete te[JSON.stringify(j)],
                H().setItem(x, JSON.stringify(te)));
            });
          },
          clear: function () {
            return Promise.resolve().then(function () {
        ...
        return x === void 0
          ? {
              get: function (H, O) {
                var W =
                  ...
                  G = O();
                return G.then(function (j) {
                  return Promise.all([j, W.miss(j)]);
                }).then(function (j) {
                  return r(j, 1)[0];
                });
              },
          ...
          : {
              get: function (H, O) {
                ...
                return x.get(H, O, W).catch(function () {
                  return s({ caches: L }).get(H, O, W);
                });
              },
              set: function (H, O) {
                return x.set(H, O).catch(function () {
                  return s({ caches: L }).set(H, O);
                });
              },
              delete: function (H) {
                return x.delete(H).catch(function () {
                  return s({ caches: L }).delete(H);
                });
              },
              clear: function () {
                return x.clear().catch(function () {
                  return s({ caches: L }).clear();
                });
              },
            };
      }
        ...
        return {
          get: function (x, H) {
            var O =
              ...
              W = JSON.stringify(x);
            if (W in L)
              return Promise.resolve(S.serializable ? JSON.parse(L[W]) : L[W]);
            var G = H(),
              j =
                (O && O.miss) ||
                function () {
          ...
          set: function (x, H) {
            return (
              (L[JSON.stringify(x)] = S.serializable ? JSON.stringify(H) : H),
              Promise.resolve(H)
            );
          },
          delete: function (x) {
            return (delete L[JSON.stringify(x)], Promise.resolve());
          },
          clear: function () {
      ...
      function b(S, L) {
        ...
        return (
          ...
          {
            data: Object.entries(H).length > 0 ? H : void 0,
            timeout: x.timeout || L,
            headers: x.headers || {},
      ...
      function D(S) {
        ...
        return n(n({}, S), {}, { status: L, lastUpdate: Date.now() });
      }
      function K(S) {
        return typeof S == "string"
          ? { protocol: "https", url: S, accept: w.Any }
          : {
              protocol: S.protocol || "https",
              url: S.url,
              accept: S.accept || w.Any,
            };
      }
      var C = "GET",
        ee = "POST";
      function ye(S, L) {
        return Promise.all(
          L.map(function (x) {
            return S.get(x, function () {
              return Promise.resolve(D(x));
            });
          }),
        ).then(function (x) {
          var H = x.filter(function (G) {
              return (function (j) {
                return j.status === E || Date.now() - j.lastUpdate > 12e4;
              })(G);
            }),
            O = x.filter(function (G) {
              return (function (j) {
                return j.status === k && Date.now() - j.lastUpdate <= 12e4;
              })(G);
            }),
            W = [].concat(i(H), i(O));
          return {
            getTimeout: function (G, j) {
              return (O.length === 0 && G === 0 ? 1 : O.length + 3 + G) * j;
            },
            statelessHosts:
              W.length > 0
                ? W.map(function (G) {
      ...
      function he(S, L, x, H) {
        var O = [],
          W = (function (ce, Me) {
            if (!(
              ce.method === C ||
              (ce.data === void 0 && Me.data === void 0)
            )) {
              var ne = Array.isArray(ce.data)
                ? ce.data
                : n(n({}, ce.data), Me.data);
          ...
          G = (function (ce, Me) {
            var ne = n(n({}, ce.headers), Me.headers),
              we = {};
            return (
              Object.keys(ne).forEach(function (qe) {
                var be = ne[qe];
                we[qe.toLowerCase()] = be;
              }),
              we
            );
          })(S, H),
          j = x.method,
          te = x.method !== C ? {} : n(n({}, x.data), H.data),
          se = n(
            n(
              n({ "x-algolia-agent": S.userAgent.value }, S.queryParameters),
              te,
            ),
            H.queryParameters,
          ),
          le = 0,
          fe = function ce(Me, ne) {
            var we = Me.pop();
            if (we === void 0)
              throw {
                name: "RetryError",
            ...
            var qe = {
                ...
                method: j,
                url: V(we, x.path, se),
                connectTimeout: ne(le, S.timeouts.connect),
                responseTimeout: ne(le, H.timeout),
              },
              be = function (me) {
                var Z = {
                  request: qe,
              ...
              at = {
                onSuccess: function (me) {
                  return (function (Z) {
                    try {
                      return JSON.parse(Z.content);
                    } catch (He) {
                      throw (function (Re, Ve) {
                        return {
                          name: "DeserializationError",
                          message: Re,
                          response: Ve,
                ...
                onRetry: function (me) {
                  ...
                  return (
                    me.isTimedOut && le++,
                    Promise.all([
                      S.logger.info("Retryable failure", Vt(Z)),
                      S.hostsCache.set(we, D(we, me.isTimedOut ? k : T)),
                    ]).then(function () {
                      return ce(Me, ne);
                    })
                  );
                  ...
                  throw (
                    ...
                    (function (Z, He) {
                      var Re = Z.content,
                        ...
                        Pe = Re;
                      try {
                        Pe = JSON.parse(Re).message;
                      } catch {}
                      return (function (gt, kt, qn) {
                        return {
                          name: "ApiError",
                          message: gt,
                          status: kt,
                          transporterStackTrace: qn,
                        };
                      })(Pe, Ve, He);
                    })(me, mt(O))
                  );
            ...
            return S.requester.send(qe).then(function (me) {
        ...
        return ye(S.hostsCache, L).then(function (ce) {
          return fe(i(ce.statelessHosts).reverse(), ce.getTimeout);
        });
      }
      function X(S) {
        var L = {
          value: "Algolia for JavaScript (".concat(S, ")"),
          add: function (x) {
            var H = "; "
              .concat(x.segment)
            ...
            return (
              L.value.indexOf(H) === -1 &&
                (L.value = "".concat(L.value).concat(H)),
              L
            );
          },
        };
      ...
      function V(S, L, x) {
        var H,
                ...
                return (function (te) {
                  for (
                    var se = arguments.length,
                      le = new Array(se > 1 ? se - 1 : 0),
                      fe = 1;
                    fe < se;
                    fe++
                  )
                    le[fe - 1] = arguments[fe];
                  var ce = 0;
                  return te.replace(/%s/g, function () {
                    return encodeURIComponent(le[ce++]);
                  });
                })(
                  "%s=%s",
                  G,
          ...
          W = ""
            .concat(S.protocol, "://")
            .concat(S.url, "/")
            .concat(L.charAt(0) === "/" ? L.substr(1) : L);
        return (O.length && (W += "?".concat(O)), W);
      }
      function mt(S) {
      ...
      function Vt(S) {
        var L = S.request.headers["x-algolia-api-key"]
          ? { "x-algolia-api-key": "*****" }
          : {};
        return n(
          n({}, S),
          {},
          {
            request: n(
              n({}, S.request),
              {},
              { headers: n(n({}, S.request.headers), L) },
            ),
          },
        );
      }
      var zt = function (S) {
          var L = S.appId,
            x = (function (O, W, G) {
              var j = { "x-algolia-api-key": G, "x-algolia-application-id": W };
              return {
                headers: function () {
                  return O === g.WithinHeaders ? j : {};
                },
                queryParameters: function () {
                  return O === g.WithinQueryParameters ? j : {};
                },
              };
            })(
              S.authMode !== void 0 ? S.authMode : g.WithinHeaders,
              L,
              S.apiKey,
            ),
            H = (function (O) {
              var W = O.hostsCache,
                ...
                ne = {
                  ...
                  headers: O.headers,
                  queryParameters: Me,
                  hosts: ce.map(function (we) {
                    return K(we);
                  }),
                  read: function (we, qe) {
                    var be = b(qe, ne.timeouts.read),
                      at = function () {
                        return he(
                          ne,
                          ne.hosts.filter(function (Z) {
                            return (Z.accept & w.Read) != 0;
                          }),
                          we,
                          be,
                        );
                    ...
                    var me = {
                      request: we,
                      mappedRequestOptions: be,
                      transporter: {
                        queryParameters: ne.queryParameters,
                        headers: ne.headers,
                      },
                    };
                    return ne.responsesCache.get(
                      me,
                      function () {
                        return ne.requestsCache.get(me, function () {
                          return ne.requestsCache
                            .set(me, at())
                            .then(
                              function (Z) {
                                return Promise.all([
                                  ne.requestsCache.delete(me),
                                  Z,
                                ]);
                              },
                              function (Z) {
                      ...
                      {
                        miss: function (Z) {
                          return ne.responsesCache.set(me, Z);
                        },
                      },
                    );
                  },
                  write: function (we, qe) {
                    return he(
                      ne,
                      ne.hosts.filter(function (be) {
                        return (be.accept & w.Write) != 0;
                      }),
                      we,
                      b(qe, ne.timeouts.write),
                    );
                  },
                };
              return ne;
              ...
              n(
                n(
                  {
                    hosts: [
                      { url: "".concat(L, "-dsn.algolia.net"), accept: w.Read },
                      { url: "".concat(L, ".algolia.net"), accept: w.Write },
                    ].concat(
                      m([
                        { url: "".concat(L, "-1.algolianet.com") },
                        { url: "".concat(L, "-2.algolianet.com") },
                        { url: "".concat(L, "-3.algolianet.com") },
                      ]),
                    ),
                  },
                  S,
          ...
          return (function (O, W) {
          ...
          })(
            {
              transporter: H,
              appId: L,
              addAlgoliaAgent: function (O, W) {
                H.userAgent.add({ segment: O, version: W });
              },
              clearCache: function () {
                return Promise.all([
                  H.requestsCache.clear(),
                  H.responsesCache.clear(),
                ]).then(function () {});
              },
            },
            S.methods,
        ...
        De = function (S) {
          return function (L, x) {
            var H = L.map(function (O) {
              return n(n({}, O), {}, { threshold: O.threshold || 0 });
            });
            return S.transporter.read(
              {
                method: ee,
                path: "1/indexes/*/recommendations",
                data: { requests: H },
        ...
        Qt = function (S) {
          return function (L, x) {
            return De(S)(
              L.map(function (H) {
                return n(n({}, H), {}, { model: "related-products" });
              }),
              x,
            );
          };
          ...
          return function (L, x) {
            var H = L.map(function (O) {
              return n(
                n({}, O),
                {},
                { model: "trending-facets", threshold: O.threshold || 0 },
              );
            });
            return S.transporter.read(
              {
          ...
          return function (L, x) {
            var H = L.map(function (O) {
              return n(
                n({}, O),
                {},
                { model: "trending-items", threshold: O.threshold || 0 },
              );
            });
            return S.transporter.read(
              {
        ...
        It = function (S) {
          return function (L, x) {
            return De(S)(
              L.map(function (H) {
                return n(n({}, H), {}, { model: "looking-similar" });
              }),
              x,
            );
          };
          ...
          return function (L, x) {
            var H = L.map(function (O) {
              return n(
                n({}, O),
                {},
                { model: "recommended-for-you", threshold: O.threshold || 0 },
              );
            });
            return S.transporter.read(
              {
      ...
      function ke(S, L, x) {
        var H,
          O = {
            ...
            requester: {
              send: function (W) {
                return new Promise(function (G) {
                  ...
                  (j.open(W.method, W.url, !0),
                    Object.keys(W.headers).forEach(function (fe) {
                      return j.setRequestHeader(fe, W.headers[fe]);
                    }));
                  var te,
                    se = function (fe, ce) {
                      return setTimeout(function () {
                        (j.abort(),
                          G({ status: 0, content: ce, isTimedOut: !0 }));
                      }, 1e3 * fe);
                    },
                    le = se(W.connectTimeout, "Connection timeout");
                  ((j.onreadystatechange = function () {
                    j.readyState > j.OPENED &&
                      te === void 0 &&
                      (clearTimeout(le),
                      (te = se(W.responseTimeout, "Socket timeout")));
                  }),
                    (j.onerror = function () {
                      j.status === 0 &&
                        (clearTimeout(le),
                        clearTimeout(te),
                        G({
                          content: j.responseText || "Network request failed",
                          status: j.status,
                          isTimedOut: !1,
                        }));
                    }),
            ...
            logger:
              ...
              {
                debug: function (W, G) {
                  return (u >= H && console.debug(W, G), Promise.resolve());
                },
                info: function (W, G) {
                  return (h >= H && console.info(W, G), Promise.resolve());
                },
                error: function (W, G) {
                  return (console.error(W, G), Promise.resolve());
                },
              }),
            responsesCache: c(),
            requestsCache: c({ serializable: !1 }),
            hostsCache: s({
              caches: [l({ key: "".concat("4.26.0", "-").concat(S) }), c()],
            }),
            userAgent: X("4.26.0")
              .add({ segment: "Recommend", version: "4.26.0" })
              .add({ segment: "Browser" }),
        ...
        return zt(
          n(
            ...
            {
              methods: {
                getFrequentlyBoughtTogether: Kt,
                getRecommendations: De,
                getRelatedProducts: Qt,
                getTrendingFacets: Mt,
                getTrendingItems: Ht,
                getLookingSimilar: It,
                getRecommendedForYou: Jt,
              },
            },
          ),
        );
      ...
      return (
        (ke.version = "4.26.0"),
        (ke.getFrequentlyBoughtTogether = Kt),
        (ke.getRecommendations = De),
        (ke.getRelatedProducts = Qt),
        (ke.getTrendingFacets = Mt),
        (ke.getTrendingItems = Ht),
        (ke.getLookingSimilar = It),
        (ke.getRecommendedForYou = Jt),
        ke
      );
    });
  });
  ...
  function Ie(e) {
    return e.reduce(
      function (i, n) {
        ...
        return "index" in n
          ? { additionalParams: i, events: r.concat([n]) }
          : { events: r, additionalParams: n };
      },
  ...
  ((wt.get = function (e) {
    var t = (t = this.store) == null ? void 0 : t.getItem(e);
    if (!t) return null;
    try {
      return JSON.parse(t);
    } catch {
    ...
    (wt.set = function (e, t) {
      var n;
      try {
        (n = this.store) != null && n.setItem(e, JSON.stringify(t));
      } catch {
        console.error(
          "Unable to set " + e + " in localStorage, storage may be full.",
        );
      }
    }),
    (wt.remove = function (e) {
      var t;
      (t = this.store) != null && t.removeItem(e);
    }),
    (wt.store = El()));
  var Ur = "AlgoliaObjectQueryCache",
    Tl = 5e3,
    Sl = 1e3;
  function Nn() {
    var e;
    return (e = wt.get(Ur)) != null ? e : {};
  }
  function Br(e) {
    wt.set(Ur, Al(e));
  }
  function Al(e) {
    return Object.keys(e).length > Tl ? Ll(e) : e;
  }
  function Ll(e) {
    return (
      (e = Object.entries(e).sort(function (t, n) {
        return ((t = t[1][1]), n[1][1] - t);
      })),
      e.slice(0, e.length - Sl - 1).reduce(function (t, i) {
        var r = i[0],
          i = i[1];
        return Object.assign(Object.assign({}, t), (((t = {})[r] = i), t));
      }, {})
    );
  }
  function _n(e, t) {
  ...
  function kl(e) {
    return function (t) {
      for (var n = [], r = arguments.length - 1; 0 < r--;)
        n[r] = arguments[r + 1];
      if (t && Ke(e[t])) return e[t].apply(e, n);
      console.warn("The method `" + t + "` doesn't exist.");
    };
  }
  var ql = ["insights-js (" + Zt + ")", "insights-js-browser-esm (" + Zt + ")"];
  function Pl(e) {
    this._ua.indexOf(e) === -1 && this._ua.push(e);
  }
  function Cl(e) {
    return (Ke(e) && e(this.version), this.version);
  }
  function $n(e, t) {
    var n = {};
    for (i in e)
      ...
      return !Ol(t) ||
        ...
        (r =
          (r = t.objectIDs) == null
            ? void 0
            : r.map(function (i, o) {
                var l = (l = t.objectData) == null ? void 0 : l[o];
                return l != null && l.queryID
                  ? l
                  : ((o = ((o = xl(t.index, i)) != null ? o : [])[0]) &&
                      n.push(i),
                    Object.assign(Object.assign({}, l), { queryID: o }));
              })),
        n.length === 0)
        ? t
        : Object.assign(Object.assign({}, t), {
            objectData: r,
            objectIDsWithInferredQueryID: n,
          });
    });
  }
  function Ol(e) {
    return !e.queryID && e.eventType === "conversion";
  }
  function Dl(e) {
    return function (t, n) {
      var r = this;
      ...
      if (!(
        (!Ct(this._apiKey) && !Ct(this._appId)) ||
        ((i = n?.headers) != null &&
      ...
      !this._userToken &&
        ...
        this.setAnonymousUserToken(!0);
      var i = (n != null && n.inferQueryID ? Fl(t) : t).map(function (c) {
        var l = c.filters,
          s = $n(c, ["filters"]),
          c = Object.assign(Object.assign({}, s), {
            userToken: (s = c?.userToken) != null ? s : r._userToken,
            authenticatedUserToken:
              (s = c?.authenticatedUserToken) != null
                ? s
                : r._authenticatedUserToken,
          });
        return (Ct(l) || (c.filters = l.map(encodeURIComponent)), c);
      });
      return i.length === 0
        ? Promise.resolve(!1)
        : ((t = jl(
          ...
          e
            .filter(function (o) {
              var r = o.eventType,
                i = o.eventSubtype,
                o = o.objectIDs;
              return r === "conversion" && i === "purchase" && o?.length;
            })
            .forEach(function (n) {
              return Ml(n.index, n.objectIDs);
            }),
        t
      );
    };
  }
  function jl(e, t, n, r, i, o, m) {
    var s = (m = m === void 0 ? {} : m)["X-Algolia-Application-Id"],
      c = m["X-Algolia-API-Key"],
      m = $n(m, ["X-Algolia-Application-Id", "X-Algolia-API-Key"]),
      g = Object.assign(
        {
          "X-Algolia-Application-Id": s ?? i,
          "X-Algolia-API-Key": c ?? o,
  ...
  var en = "_ALGOLIA",
    ...
    Vr = function (e, t, i) {
      var r = new Date(),
        i = (r.setTime(r.getTime() + i), "expires=" + r.toUTCString());
  ...
  function Nl(e) {
    return typeof e != "number" && e.indexOf("anonymous-") === 0;
  }
  function _l() {
    var e = zr(en);
    !this._userToken ||
      (e && e !== "" && e.indexOf("anonymous-") === 0) ||
      Vr(en, this._userToken, this._cookieDuration);
  }
  function Wl(e) {
    (e = e !== void 0 && e)
      ? this.setUserToken("anonymous-" + jn())
      : wl() &&
        ((e = zr(en)) && e !== "" && e.indexOf("anonymous-") === 0
          ? this.setUserToken(e)
          : ((e = this.setUserToken("anonymous-" + jn())),
            Vr(en, e, this._cookieDuration)));
  }
  function $l(e) {
    return (
      (this._userToken = e),
      Ke(this._onUserTokenChangeCallback) &&
        this._onUserTokenChangeCallback(this._userToken),
      this._userToken
    );
  }
  function Ul(e, t) {
    return (Ke(t) && t(null, this._userToken), this._userToken);
  }
  function Bl(e, t) {
  ...
  function Gl(e) {
    return (
      (this._authenticatedUserToken = e),
      Ke(this._onAuthenticatedUserTokenChangeCallback) &&
  ...
  function Vl(e, t) {
    return (
      Ke(t) && t(null, this._authenticatedUserToken),
      this._authenticatedUserToken
    );
  }
  function zl(e, t) {
    ((this._onAuthenticatedUserTokenChangeCallback = e),
      t &&
        t.immediate &&
        Ke(this._onAuthenticatedUserTokenChangeCallback) &&
        this._onAuthenticatedUserTokenChangeCallback(
  ...
  function Qe(e, t) {
    return t.map(function (n) {
      return Object.assign({ eventType: e }, n);
    });
  }
  function tn(e, t, n) {
    return n.map(function (r) {
      return Object.assign({ eventType: e, eventSubtype: t }, r);
    });
  }
  function Kl() {
    ...
    return (
      r.forEach(function (o) {
        var l = o.index,
          s = o.queryID;
        return o.objectIDs.forEach(function (c) {
          return !e._userHasOptedOut && Wn(l, c, s);
        });
      }),
      this.sendEvents(Qe("click", r), i)
    );
  }
  function Ql() {
    ...
    return this.sendEvents(Qe("click", n), r);
  }
  function Jl() {
    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
    var r = Ie(e),
  ...
  function Xl() {
    ...
    var r = Ie(e),
      n = r.events,
      r = r.additionalParams;
    return this.sendEvents(Qe("conversion", n), r);
  }
  function Yl() {
    for (var e = this, t = [], n = arguments.length; n--;) t[n] = arguments[n];
    var i = Ie(t),
    ...
    return (
      r.forEach(function (o) {
        var l = o.index,
          ...
          c = o.objectIDs,
          m = o.objectData;
        return c.forEach(function (g, u) {
          ((u =
            (u = (u = m?.[u]) == null ? void 0 : u.queryID) != null ? u : s),
            !e._userHasOptedOut && u && Wn(l, g, u));
        });
      }),
      this.sendEvents(tn("conversion", "addToCart", r), i)
    );
  }
  function Zl() {
    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
    var r = Ie(e),
      n = r.events,
      r = r.additionalParams;
    return this.sendEvents(tn("conversion", "purchase", n), r);
  }
  function es() {
    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
    var r = Ie(e),
    ...
    return (
      r.forEach(function (o) {
        var l = o.index,
          s = o.objectIDs,
          c = o.objectData;
        return s.forEach(function (m, g) {
          ((g = (g = c?.[g]) == null ? void 0 : g.queryID),
            !e._userHasOptedOut && g && Wn(l, m, g));
        });
      }),
      this.sendEvents(tn("conversion", "addToCart", r), i)
    );
  ...
  function is(e) {
    var t;
    if (!Ct((e = e === void 0 ? {} : e).region) && $r.indexOf(e.region) === -1)
      throw new Error(
    ...
    (os(this, e, {
      ...
      _region: e.region,
      _host: e.host,
      _anonymousUserToken: (t = e.anonymousUserToken) == null || t,
      _useCookie: (t = e.useCookie) != null && t,
      _cookieDuration: e.cookieDuration || 6 * Gr,
    }),
      (this._endpointOrigin =
        this._host ||
        (this._region
      ...
      (this._ua = [].concat(ql)),
      e.authenticatedUserToken &&
        this.setAuthenticatedUserToken(e.authenticatedUserToken),
      e.userToken
        ? this.setUserToken(e.userToken)
        : this._userToken || this._userHasOptedOut || !this._useCookie
          ? as(this) && this.saveTokenAsCookie()
  ...
  function ls() {
    ...
    var r = Ie(e),
      n = r.events,
      r = r.additionalParams;
    return this.sendEvents(Qe("view", n), r);
  }
  function ss() {
    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
    var r = Ie(e),
  ...
  var cs = function (e) {
    ((e = e.requestFn),
      ...
      (this._anonymousUserToken = !0),
      (this._userHasOptedOut = !1),
      (this._useCookie = !1),
      (this._cookieDuration = 6 * Gr),
      (this._ua = []),
      (this.version = Zt),
      (this.sendEvents = Dl(e).bind(this)),
      (this.init = is.bind(this)),
      (this.addAlgoliaAgent = Pl.bind(this)),
      (this.saveTokenAsCookie = _l.bind(this)),
      (this.setUserToken = $l.bind(this)),
      (this.setAnonymousUserToken = Wl.bind(this)),
      (this.getUserToken = Ul.bind(this)),
      (this.onUserTokenChange = Bl.bind(this)),
      (this.setAuthenticatedUserToken = Gl.bind(this)),
      (this.getAuthenticatedUserToken = Vl.bind(this)),
      (this.onAuthenticatedUserTokenChange = zl.bind(this)),
      (this.clickedObjectIDsAfterSearch = Kl.bind(this)),
      (this.clickedObjectIDs = Ql.bind(this)),
      (this.clickedFilters = Jl.bind(this)),
      (this.convertedObjectIDsAfterSearch = Xl.bind(this)),
      (this.purchasedObjectIDsAfterSearch = Zl.bind(this)),
      (this.addedToCartObjectIDsAfterSearch = Yl.bind(this)),
      (this.convertedObjectIDs = es.bind(this)),
      (this.addedToCartObjectIDs = ts.bind(this)),
      (this.purchasedObjectIDs = ns.bind(this)),
      (this.convertedFilters = rs.bind(this)),
      (this.viewedObjectIDs = ls.bind(this)),
      (this.viewedFilters = ss.bind(this)),
      (this.getVersion = Cl.bind(this)));
  };
  function us(n) {
    var t,
      n = kl(new cs({ requestFn: n }));
    if (typeof window == "object" && !window.AlgoliaAnalyticsObject) {
      for (; (t = jn()), window[t] !== void 0;);
      ((window.AlgoliaAnalyticsObject = t),
        (window[window.AlgoliaAnalyticsObject] = n));
    }
    return ((n.version = Zt), n);
  }
  var Kr = function (e, t) {
    ...
    fs = function (e, t) {
      ...
      return Promise.resolve(!!n || Kr(e, t));
    },
    ds = function (e, t) {
      return new Promise(function (n, r) {
        fetch(e, {
...
Verbatim Algolia error: ${E.message ?? "(no message)"}`));
  ...
  var wo = Wr(ho(), 1),
    yr = null;
  function yo(e) {
    return (yr || (yr = (0, wo.default)(e.appId, e.searchKey)), yr);
  }
  var fc = /^[a-z][a-z0-9-]*$/;
  function bo() {
  ...
  async function ra(e, t, n) {
    let r = (0, na.default)(t.appId, t.searchKey),
      i = n.get("recommend") || [];
    for (let o of i) {
